<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"C:\wamp64\www\tp1\public/../ems/mangeuser\view\shop\addcate.html";i:1539418120;s:54:"C:\wamp64\www\tp1\ems\mangeuser\view\public\_head.html";i:1539589474;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<script>
    ...
    <div class="rightContent">
        <div class="rightTitel">
            <nav class="breadcrumb">
                <span><i class="fa fa-barcode"></i> 栏目管理&nbsp;<b>/</b>&nbsp;添加栏目</span>
            </nav>
        </div>
           ...
           <div class="cate my-3">
            <form class="cateform">
                <div class="form-group row px-4">
                    <label for="catename" class="col-sm-2">栏目名称</label>
                    <div class="col-sm-4">
                        <input type="text" name="catename" id="catename" class="form-control">
                    </div> 
                </div>
                <div class="form-group row px-4">
                    <label for="catename" class="col-sm-2">排序</label>
                    <div class="col-sm-3">
                        <label class="radio-inline">
                                <input type="radio" name="sort" id="sort"  value="1">是
                        </label>
                        <label class="radio-inline mx-3">
                                <input type="radio" name="sort" id="sort" value="0">否
                        </label>
                    </div> 
                </div>
    ...
    $("#add").click(function (e) { 
        ...
        $.ajax({
            type: "post",
            url: "<?php echo url('mangeuser/shop/addcate'); ?>",
