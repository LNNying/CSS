<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"C:\wamp64\www\tp1\public/../ems/mangeuser\view\shop\comment.html";i:1539590018;s:54:"C:\wamp64\www\tp1\ems\mangeuser\view\public\_head.html";i:1539589474;}*/ ?>
...
<!-- 左侧导航栏 -->
<!-- 右侧显示区域 -->
<div class="rightArtical rightcomment">
    <div class="rightTitel">
        <nav class="breadcrumb">
            <span><i class="fa fa-book"></i> 评论管理&nbsp;<b>/</b>&nbsp;评论列表</span>
        </nav>
    </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $vo['artical']['title']; ?></td>
                        <td><?php echo $vo['member']['nickname']; ?></td>
                        <td><?php echo $vo['content']; ?></td>
                        <td>
                            <button id="<?php echo $vo['id']; ?>" class="btn btn-danger delComment">删除</button>
                        </td>
                    </tr>
...
<script>
    $(function () {
        ...
        $('.delComment').click(function (e) {
            ...
            var id = $(this).attr("id");
            var data = { "id": id }
            layer.confirm('您确定要删除这条评论吗?', { icon: 3, title: '删除评论' }, function (index) {
                $.ajax({
                    type: "post",
                    url: "<?php echo url('mangeuser/shop/comment'); ?>",
                    data: data,
                    dataType: "json",
                    success: function (data) {
                        if (data.code == 1) {
