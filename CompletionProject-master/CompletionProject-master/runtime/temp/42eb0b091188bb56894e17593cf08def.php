<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"C:\wamp64\www\phone\public/../ems/index\view\index\edit_manger.html";i:1552384479;s:53:"C:\wamp64\www\phone\ems\index\view\public\__head.html";i:1557393599;s:55:"C:\wamp64\www\phone\ems\index\view\public\__footer.html";i:1555944734;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                    ...
                    <tr>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm" style="float:left;">
                                ...
                                <input type="text" class="form-control" id="manger_no" name="" value="<?php echo $data['manger_no']; ?>" disabled style="width: 180px;" placeholder="编号">
                            </div>
                            <div style="float:left;margin-left: 2px;">
                                <button type="button" class="btn btn-sm btn-success" id="getNo" style="float:left;" disabled>获取</button>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <input type="text" class="form-control" id="name" name="" value="<?php echo $data['manger_name']; ?>" placeholder="姓名">
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <div class="col-sm-4">
                <table>
                    <tr>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <input type="password" class="form-control" id="pass" name="" value="<?php echo $data['pass']; ?>" placeholder="密码">
                            </div>
                        </td>
                    </tr>
                </table>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <select class="form-control" id="sex">
                                    <option value="0" <?php if($data['sex'] == '0'): ?>selected<?php endif; ?>>男</option>
                                    <option value="1" <?php if($data['sex'] == '1'): ?>selected<?php endif; ?>>女</option>
                                </select>
                            </div>
                        </td>
                    </tr>
            ...
            <div class="col-sm-4">
                <table>
                    <tr>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <input type="text" class="form-control" id="address" name="" value="<?php echo $data['address']; ?>" placeholder="地址">
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <div class="col-sm-4">
                <table>
                    <tr>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <select class="form-control" id="marry" value="<?php echo $data['marry']; ?>">
                                    <option value="0" <?php if($data['marry'] == '0'): ?>selected<?php endif; ?>>未婚</option>
                                    <option value="1" <?php if($data['marry'] == '1'): ?>selected<?php endif; ?>>已婚</option>
                                </select>
                            </div>
                        </td>
                    </tr>
            ...
            <div class="col-sm-4">
                <table>
                    <tr>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <input type="text" class="form-control" id="phone" name="" value="<?php echo $data['phone']; ?>" placeholder="手机号">
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <div class="col-sm-4">
                <table>
                    <tr>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <input type="email" class="form-control" id="email" name="<?php echo $data['email']; ?>" value="" placeholder="邮箱">
                            </div>
                        </td>
                    </tr>
                </table>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <select class="form-control" id="department">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $data['department_id']): ?>selected<?php endif; ?>><?php echo $vo['department_name']; ?></option>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <select class="form-control" id="role">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $data['role_id']): ?>selected<?php endif; ?>><?php echo $vo['role_name']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </td>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <select class="form-control" id="incumbency">
                                    <option></option>
                                    <option value="0" <?php if($data['incumbency'] == '0'): ?>selected<?php endif; ?>>在职员工</option>
                                    <option value="1" <?php if($data['incumbency'] == '1'): ?>selected<?php endif; ?>>实习员工</option>
                                </select>
                            </div>
                        </td>
                    </tr>
            ...
            <div class="col-sm-4">
                <table>
                    <tr>
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <input type="text" class="form-control" id="year" name="" value="<?php echo $data['jobyear']; ?>" placeholder="期限">
                            </div>
                        </td>
                    </tr>
                </table>
...
<script>
    $(function () {
        ...
        $('#submits').click(function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('index/index/editManger'); ?>",
                data: mangerInfo,
                dataType: "json",
                success: function (data) {
                    if (data.code == 1) {
