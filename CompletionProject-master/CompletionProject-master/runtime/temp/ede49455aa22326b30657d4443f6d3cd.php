<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"C:\wamp64\www\phone\public/../ems/index\view\index\add_pro.html";i:1555952141;s:53:"C:\wamp64\www\phone\ems\index\view\public\__head.html";i:1557393599;s:55:"C:\wamp64\www\phone\ems\index\view\public\__footer.html";i:1555944734;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                        ...
                        <td class="pl-10">
                            <div class="input-group-sm">
                                <select class="form-control" id="supplier">
                                    ...
                                    <option value="<?php echo $vo['id']; ?>"><?php echo $vo['sup_name']; ?></option>
...
<script>
    $(function () {
        ...
        $('#submitPro').click(function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('index/index/addPro'); ?>",
                data: data,
                dataType: "json",
                success: function (data) {
                    if (data.code == 1) {
