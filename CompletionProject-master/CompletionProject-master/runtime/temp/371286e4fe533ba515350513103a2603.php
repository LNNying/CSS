<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"C:\wamp64\www\tp1\public/../ems/mangeuser\view\shop\addartical.html";i:1539418097;s:54:"C:\wamp64\www\tp1\ems\mangeuser\view\public\_head.html";i:1539589474;}*/ ?>
                ...
                <form class="artical mx-5">
                    ...
                    <div class="form-group row px-5">
                        <div class="form-check form-check-inline col-sm-4 offset-sm-2">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="is_top" id="is_top" value="1">置顶
                            </label>
                        </div>
                    </div>
                    <div class="form-group row px-4">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-3 offset-sm-4">
                            <button class="btn btn-success" id="addArtical">添加</button>
    ...
    <script>
        $(function(){
            ...
            $("#addArtical").click(function (e) { 
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo url('mangeuser/shop/addartical'); ?>",
