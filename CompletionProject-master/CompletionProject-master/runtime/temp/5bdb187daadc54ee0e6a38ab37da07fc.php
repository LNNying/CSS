<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"C:\wamp64\www\tp1\public/../ems/mangeuser\view\shop\memberadd.html";i:1539590251;s:54:"C:\wamp64\www\tp1\ems\mangeuser\view\public\_head.html";i:1539589474;}*/ ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="cate my-3 mx-5">
                <form class="member">
                    <div class="form-group row px-4">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="username" id="usernmae" class="form-control" placeholder="请输入会员账号">
                        </div>
                    </div>
                    <div class="form-group row px-4">
                            <label for="nickname" class="col-sm-2">昵称</label>
                            <div class="col-sm-4">
                                <input type="text" name="nickname" id="nickname" class="form-control" placeholder="请输入会员密码">
                            </div>
                        </div>
                    <div class="form-group row px-4">
                        <label for="password" class="col-sm-2">密码</label>
                        <div class="col-sm-4">
                            <input type="password" name="password" id="password" class="form-control" placeholder="请输入会员昵称">
                        </div>
                    </div>
                    ...
                    <div class="form-group row px-4">
                            ...
                            <div class="col-sm-4">
                                <input type="email" name="email" id="email" class="form-control" placeholder="请输入会员邮箱">
                            </div>
                        </div>
                    <div class="form-group row">
                        <div class="col-sm-3 offset-sm-4">
                            <button class="btn btn-success" id="addmember">添加</button>
    ...
    <script>
        $(function () {
            ...
            $('#addmember').click(function (e) {
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo url('mangeuser/shop/memberadd'); ?>",
