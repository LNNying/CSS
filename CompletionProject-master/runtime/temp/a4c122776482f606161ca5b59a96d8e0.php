<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"C:\wamp64\www\phone\public/../ems/index\view\index\client_list.html";i:1556540068;s:53:"C:\wamp64\www\phone\ems\index\view\public\__head.html";i:1557393599;s:55:"C:\wamp64\www\phone\ems\index\view\public\__footer.html";i:1555944734;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div style="width: 100%;height: auto; margin-top: 5px;">
        <table class="table table-bordered table-striped table-sm table-hover table-responsive-sm"
            ...
            <tr>
                ...
                <td><?php echo $vo['client_no']; ?></td>
                <td><?php echo $vo['client_name']; ?></td>
                <td><?php echo $vo['address']; ?></td>
                <td><?php echo $vo['phone']; ?></td>
                <td><?php if($vo['job'] == ''): ?>未填<?php else: ?><?php echo $vo['job']; endif; ?></td>
                <td><?php echo $vo['manger_c']['manger_name']; ?></td>
...
<script>
    $(function () {
        $('.delManger').click(function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('index/index/deleteClientInfo'); ?>",
                data: delId,
                dataType: "json",
                success: function (data) {
                    if (data.code == 1) {
        ...
        $('#update').click(function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('index/index/updateClientInfo'); ?>",
                data: update,
                dataType: "json",
                success: function (data) {
                    if (data.code == 1) {
        ...
        $('.edit').click(function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('index/index/getClientInfo'); ?>",
                data: id,
                dataType: "json",
                success: function (data) {
                    console.log(data);
        ...
        $('#save').click(function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('index/index/saveClientInfo'); ?>",
                data: info,
                dataType: "json",
                success: function (data) {
                    if (data.code == 1) {
