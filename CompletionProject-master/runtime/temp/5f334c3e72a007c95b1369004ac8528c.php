<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"C:\wamp64\www\phone\public/../ems/index\view\index\order_list.html";i:1555990692;s:53:"C:\wamp64\www\phone\ems\index\view\public\__head.html";i:1557393599;s:55:"C:\wamp64\www\phone\ems\index\view\public\__footer.html";i:1555944734;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="content" style="height: auto;margin-bottom: 10px;padding-bottom: 20px;">
    ...
    <div style="margin-top: 5px;">
        <a class="btn btn-success btn-sm" href="<?php echo url('index/index/addOrder'); ?>">添加</a>
    </div>
    <div style="width: 100%;height: auto; margin-top: 5px;">
        <table class="table table-bordered table-striped table-sm table-hover table-responsive-sm" style="text-align: center;">
            ...
            <tr>
                ...
                <td><?php echo $vo['product_o']['pro_name']; ?></td>
                <td><?php echo $vo['manger_o']['manger_name']; ?></td>
                <td><?php echo $vo['product_o']['price']; ?>元</td>
                <?php if($vo['pro_num'] == ''): ?>
                <td>0件</td>
                <?php else: ?>
                <td><?php echo $vo['pro_num']; ?>件</td>
                <?php endif; ?>
                ...
                <td>
                    <?php if($vo['state'] == 0): ?>
                    <a  class="btn btn-sm btn-info" href="<?php echo url('index/index/editOrder'); ?>?id=<?php echo $vo['id']; ?>">编辑</a>
                    <button type="button" class="btn btn-success btn-sm approve" id="approve" data-id="<?php echo $vo['id']; ?>">审批</button>
                    <?php endif; ?>
...
<script>
    $(function () {
        $('.delManger').click(function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('index/index/deleteOrderInfo'); ?>",
                data: delId,
                dataType: "json",
                success: function (data) {
                    if (data.code == 1) {
        ...
        $('.approve').click(function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('index/index/approve'); ?>",
                data: approve,
                dataType: "json",
                success: function (data) {
                    if (data.code == 1) {
