<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:63:"C:\wamp64\www\tp1\public/../ems/mangeuser\view\shop\person.html";i:1539590334;s:54:"C:\wamp64\www\tp1\ems\mangeuser\view\public\_head.html";i:1539589474;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="rightArtical rightContent">
    <div class="rightTitel">
        <nav class="breadcrumb">
            <span><i class="fa fa-cog"></i> 系统管理&nbsp;<b>/</b>&nbsp;个人信息表</span>
        </nav>
    </div>
        ...
        <div class="cate my-3 mx-5">
            <form class="person">
                ...
                <div class="form-group row px-4">
                    <label for="username" class="col-sm-2">管理员名称</label>
                    <div class="col-sm-4">
                        <input type="text" name="username" id="usernmae" class="form-control" value="<?php echo $data['username']; ?>"
                            disabled>
                    </div>
                </div>
                <div class="form-group row px-4">
                ...
                <div class="form-group row px-5">
                    <div class="form-check form-check-inline col-sm-4 offset-sm-2">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="is_super" id="is_super" value="1" disabled <?php if($data['is_super'] == 1): ?>checked<?php endif; ?>>超级管理员
                        </label>
                    </div>
                </div>
                <div class="form-group row px-5">
                        <div class="form-check form-check-inline col-sm-4 offset-sm-2">
                            <label class="form-check-label">
                                <input type="checkbox" class="form-check-input" name="is_super" id="is_super" value="1" disabled <?php if($data['statue'] == 1): ?>checked<?php endif; ?>>启用
                            </label>
                        </div>
                    </div>
                <div class="form-group row">
                    <div class="col-sm-3 offset-sm-4">
                        <button class="btn btn-success" id="editperson">编辑</button>
...
<script>
    $(function () {
        ...
        $('#editperson').click(function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('mangeuser/shop/person'); ?>",
