<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"C:\wamp64\www\phone\public/../ems/index\view\index\evaluate_list.html";i:1556348859;s:53:"C:\wamp64\www\phone\ems\index\view\public\__head.html";i:1557393599;s:55:"C:\wamp64\www\phone\ems\index\view\public\__footer.html";i:1555944734;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div style="width: 100%;height: auto; margin-top: 5px;">
        <table class="table table-bordered table-striped table-sm table-hover table-responsive-sm"
            ...
            <tr>
                ...
                <td><?php echo $vo['serve_e']['ser_no']; ?></td>
                <td><?php echo $vo['client_e']['client_name']; ?></td>
                <td><?php echo $vo['serve_e']['ser_desc']; ?></td>
                <td><?php echo $vo['e_desc']; ?></td>
                <?php if($vo['state'] == 1): ?>
...
<script>
    $(function () {
        $('.delManger').click(function (e) {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo url('index/index/deleteEvaluateInfo'); ?>",
                data: delId,
                dataType: "json",
                success: function (data) {
                    if (data.code == 1) {
